 ...
 * generated in the com.self.serializable.xml.webservice.client package. 
...
public class ObjectFactory {
    ...
    private final static QName _GetValueResponse_QNAME = new QName("http://server.webservice.xml.serializable.self.com/", "getValueResponse");
    private final static QName _GetValue_QNAME = new QName("http://server.webservice.xml.serializable.self.com/", "getValue");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.self.serializable.xml.webservice.client
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://server.webservice.xml.serializable.self.com/", name = "getValueResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://server.webservice.xml.serializable.self.com/", name = "getValue")
